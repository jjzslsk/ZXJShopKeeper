...
function shopClasssPicker(cityObj,calFun) {
	if (picker == undefined || picker == null || picker == '') {
		initPicker(cityObj);
	}
	calFunPacker=calFun;
...
// console.log (JSON.stringify (firstPicker))
// console.log (JSON.stringify (secondPicker))
// console.log (JSON.stringify (thirdPicker))
// console.log (JSON.stringify (selectedIndex))
// console.log (JSON.stringify (checkedPicker))
...
/**创建只选择到城市的选择框*/
function shopClassPickerCity(cityObj,calFun) {
	if (pickerCity == undefined || pickerCity == null || pickerCity == '') {
